...
def _tokenize_captions(examples, template, tokenizer=None, is_train=True):
    ...
    for example in examples:
        ...
        #print("Metas data:", example["metas"].data)
...
def _preprocess_bbox(bbox_mode, canvas_size, examples, is_train=True,
    ...
    #print("example_3d666666666666666666666666666666666324333333333333333333333333333",examples["instance_token_3d"])
    ...
    instance_token_3d: List[torch.Tensor] = [
        example["instance_token_3d"] for example in examples]
        
        
    #print("88888888888888888",gt_labels_3d)
    #print("222",instance_kf)
    '''
    instance_token_3d: List[str] = [
    example["instance_token_3d"] for example in examples]

    instance_token_3d = [
        int(hex_str, 16) for arr in instance_token_3d if arr.dtype.type is np.str_ for hex_str in arr
    ]
    '''
    ...
    '''
    print("example_3d7777777777777777777777777777777777766666324333333333333333333333333333",instance_token_3d)
    print("example_3d7777777777777777777777777777777777766666324333333333333333333333333333",type(instance_token_3d))
    print("example_3d7777777777777777777777777777777777766666324333333333333333333333333333",type(gt_labels_3d))
    print("example_3d7777777777777777777777777777777777766666324333333333333333333333333333",gt_labels_3d)
    print("example_3d7777777777777777777777777777777777766666324333333333333333333333333333",gt_labels_3d)
    print("example_3d7777777777777777777777777777777777766666324333333333333333333333333333",gt_bboxes_3d)
    #print("instance_token_3d666666666666666666666666666666666324333333333333333333333333333",instance_token_3d)
    '''
    #print(b)
    ...
    #print("99999999999llllllllllllllll8888888888888888888888888888888888888888888")
    # for each keyframe set
    for idx in range(B):
        bboxes_kf = gt_bboxes_3d[idx]
        classes_kf = gt_labels_3d[idx]
        instance_kf = instance_token_3d[idx]
        #instance_kf = instance_kf[:len(classes_kf)]

        #print("111",classes_kf.shape)
        #print("222",instance_kf.shape)
        #print("333",bboxes_kf.shape)
        
        #print("222",classes_kf)
        '''
        print("8888888888888888888888888888888888888888888")
        print("8888888888888888888888888888888888888888888",bboxes_kf)
        print("8888888888888888888888888888888888888888888",classes_kf)
        print("8888888888888888888888888888888888888888888",instance_kf)
        '''
        ...
        instance.append([instance_kf[ind] for ind in index_list])  
        #print("9999999943666666666666666666699901",classes)
        #print("999999999999999999999999999999902",classes_kf)
        #print("9999999943666666666666666666699903",instance)
        #print("9999999999999999999999999999999",instance_kf)
        #print("9999991010101010101010101019",index_list)
        ###!!!!instance.append([instance_kf[ind] for ind in index_list])
        bbox_shape = bboxes_pt.shape[1:]
    #print(bboxes)
    #print(classes)
    #print(instance)
    instance_token_3d = instance
    #print(f)
    # there is no (visible) boxes in this batch
    if max_len == 0:
        return None, None
    #print("qqqqqqqqqqqqqqqqqqqqqqqqqqqlllllllllllllllllllll",classes)
    #$$rint("qqqqqqqqqqqqqqqqqqqqqqqqqqqlllllllllllllllllllllinstance",instance)
    # pad and construct mask
    # `bbox_shape` should be set correctly
    #$$instance_token_3d = instance
    ret_dict = pad_bboxes_to_maxlen(
        [B, N_out, max_len, *bbox_shape], max_len, bboxes, classes,instance_token_3d)  #$, instance_token_3d
    return ret_dict, bboxes_coord


def pad_bboxes_to_maxlen(
        bbox_shape, max_len, bboxes=None, classes=None, instance_token_3d=None, masks=None, **kwargs): #$, instance_token_3d=None
    ...
    ret_instance_token_3d = -torch.ones(B, N_out, max_len, dtype=torch.long)
    ret_masks = torch.zeros(B, N_out, max_len, dtype=torch.bool)
    if bboxes is not None:
        for _b in range(B):
            _bboxes = bboxes[_b]
            _classes = classes[_b]
            _instance_token_3d = instance_token_3d[_b]
            for _n in range(N_out):
                ...
                ret_instance_token_3d[_b, _n, :this_box_num] = _instance_token_3d[_n]
    ...
    ret_dict = {
        ...
        "classes": ret_classes,
        "masks": ret_masks,
        "instance_token_3d": ret_instance_token_3d,
    }
    #print(ret_dict)
    #print(e)
    return ret_dict
...
def collate_fn_single(
    ...
    """
    print("88888888889666wwwwwwwww1111111111111111",len(examples))
    #print("111",type(examples))
    #print(examples)                
    if bbox_add_ratio > 0:
    ...
    # multi-view images
    #print("111",examples)        
    #pixel_values = torch.stack([examples['img'].data])            
    ...
    ret_dict = {
        ...
        #"instance_token_3d":instance_token_3d,
        "kwargs": {},
    }
...
def collate_fn(
    ...
    **kwargs,
    ...
    #print("2024.7.11-------------------",ret_dicts)
    #print("ret_dict keys:", ret_dict['kwargs']['bboxes_3d_data'])
    #print(c)
    return ret_dicts
