...
def get_parser():
    ...
    parser.add_argument("--config", type=str, default='./configs/train_pvd_1024.yaml', help="config (yaml) path")
...
#####our
    ...
    #parser.add_argument("--mode", type=str, choices=["single_view_target", "single_view_txt", "sparse_view_interp"], required=True, help="Operation mode")
    ...
    parser.add_argument("--logdir", type=str, default="./logs", help="Directory for logging")
...
def get_parser():
    parser = argparse.ArgumentParser(description="Trainer for ViewCrafter")
'''   
